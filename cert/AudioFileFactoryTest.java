...
public class AudioFileFactoryTest {
    ...
    public void testMethods() {
		...
		Utils.checkMethod(AudioFileFactory.class, Modifier.PUBLIC | Modifier.STATIC, "createAudioFile", AudioFile.class, String.class);
		
		// Only the following methods are allowed to be public on this class to fulfill the requirements
		Utils.checkAllowedAccessableMethods(AudioFileFactory.class, "createAudioFile");
	}
